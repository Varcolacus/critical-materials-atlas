...
and hafnium (identical unit values in trade data), so "gallium trade" is really a Ga+Ge+Hf bundle -- bounded here.
...
<header class="topbar"><div class="wrap">
  ...
  <nav class="topnav"><a href="./">Atlas</a><a href="companionality.html">Hostage metals</a><a href="synthesis.html">Hardest cases</a>
  <a href="production.html" class="hideable">Production</a><a href="methodology.html" class="hideable">Methodology</a>
...
<article style="max-width:1040px">
  ...
  <p class="howto-src"><b>Bias bounds (shown, not buried):</b> the ppm and production figures are the uncertain terms; every step below carries its low&ndash;high bracket. Gallium production statistics are genuinely contested &mdash; that uncertainty is part of the finding, not smoothed over. Trade caveat: gallium exports under <b>HS 811292</b>, shared with germanium and hafnium (identical unit values), so &ldquo;gallium trade&rdquo; is really a Ga+Ge+Hf bundle &mdash; see below. Inputs: <a href="out/production.json">production.json</a> + reconciled trade &rarr; <a href="out/gallium.json">gallium.json</a>.</p>
  </details></div>
...
<footer class="siteftr"><div class="wrap">
  ...
  <div class="fineprint">Gallium production statistics are contested (China unreported); constants (ppm, recovery) are literature ranges, shown with bounds. The ~94%-discarded finding is independently reproduced by peer-reviewed gallium MFA work (~95&ndash;96% Bayer-liquor loss).</div>
</div></footer>
<script>

"""Extract mixed-scope heat-pump and component trade context from local BACI archives."""
...
OUT = os.path.join(HERE, "out", "heat_pump_trade.json")
BATCHES = [
...
GROUPS = {
    "heat_pumps_other": {"title": "Heat pumps outside HS 8415", "codes": ["841861"], "boundary": "Excludes air-conditioning machines of HS 8415, including many reversible air-to-air units."},
    "reversible_aircon": {"title": "Reversible air-conditioning heat pumps", "codes": ["841581"], "boundary": "Machines with refrigeration unit and a valve for reversal; not every unit is used as primary heating."},
    "refrigeration_compressors": {"title": "Refrigerating-equipment compressors", "codes": ["841430"], "boundary": "Compressors for refrigeration, air conditioning and heat pumps; it does not isolate heat-pump use."},
    "heat_exchange_units": {"title": "Heat-exchange units", "codes": ["841950"], "boundary": "A broad industrial heading covering many non-heat-pump applications."},
}

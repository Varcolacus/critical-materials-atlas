...
| `GlobalCriticalMineralsOutlook2026.pdf` | **The full original report PDF** (14.8 MB, 370 pp) — every graph, table and image in high fidelity. Downloaded from the IEA (iea.blob.core.windows.net/assets/19c60aa0-.../GlobalCriticalMineralsOutlook2026.pdf). (C) IEA, CC BY 4.0. Authoritative source. **Kept LOCAL only (gitignored) — not committed or served from the public site**; re-download anytime from the IEA URL above. The .md/.json files are its machine-readable extraction and remain public |

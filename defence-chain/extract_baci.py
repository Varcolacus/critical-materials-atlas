"""Extract defence-material trade context from local BACI archives.

Trade context only: customs codes cannot see military end-use or captive procurement, and
gallium/germanium share one basket (811292). Read shares as availability of the traded form.
"""
...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "out", "defence_trade.json")
BATCHES = [
...
CODES = {
    "811292": {"title": "Gallium, germanium, indium etc. (unwrought basket)", "boundary": "Shared 'other minor metals' basket — gallium and germanium cannot be separated; not defence-specific."},
    "811010": {"title": "Antimony, unwrought; powders", "boundary": "Refined antimony metal; excludes trioxide and ammunition end-use."},
    "810194": {"title": "Tungsten, unwrought; powders", "boundary": "Metal/powder as traded; penetrator and carbide end-use invisible."},
    "850511": {"title": "Permanent magnets, metal (incl. rare-earth NdFeB)", "boundary": "All permanent-magnet uses; defence share not separable."},
    "810320": {"title": "Tantalum, unwrought; powders", "boundary": "Metal/powder; capacitor and defence end-use invisible."},
}

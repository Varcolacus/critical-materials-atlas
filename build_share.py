...
card(1, f'''<div class="card">
 ...
 <div class="sub">For <b>{n_cap}</b> critical materials the chokepoint is a <b>capability</b>, not an ore endowment — it <i>imports</i> the ore and <i>exports</i> the refined metal, or pulls the metal from a domestic by-product stream. <b>Export controls on ore can&rsquo;t touch it.</b> Gallium: China holds <b>~99%</b> of refined supply as a by-product moat.</div>
...
**2/** The chokepoint usually isn't the mine — it's the furnace. For {n_cap} materials the dominant supplier *imports the ore and exports the refined metal*, or pulls it from a domestic by-product stream. Export controls on ORE can't touch that. Gallium: China refines ~99%, and mines ~none of it.

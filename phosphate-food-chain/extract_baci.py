"""Extract phosphate/fertilizer trade context from local BACI archives.

Trade context only: export restrictions and captive domestic use mean these shares understate
where the resource actually sits. Read as availability of the traded form, not reserves.
"""
...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "out", "phosphate_trade.json")
BATCHES = [
...
CODES = {
    "251010": {"title": "Natural calcium phosphates (phosphate rock)", "boundary": "The rock itself; excludes acid and finished fertilizer. Some producers restrict exports."},
    "310530": {"title": "Diammonium phosphate (DAP)", "boundary": "A finished phosphate fertilizer; Morocco, China, Russia, US, Saudi lead."},
    "310540": {"title": "Monoammonium phosphate (MAP) and mixes", "boundary": "Finished phosphate fertilizer heading; contents vary."},
    "310420": {"title": "Potassium chloride (potash)", "boundary": "The K nutrient; Canada, Russia, Belarus dominate — the potash chokepoint, not phosphate."},
    "280470": {"title": "Phosphorus (elemental)", "boundary": "Industrial white/yellow P4, not fertilizer; small, China-dominated."},
}

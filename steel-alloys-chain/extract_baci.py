"""Extract steel-alloying (ferroalloy) trade context from local BACI archives.

Trade context only: ferroalloys are the alloy addition, not crude steel (a much larger, separate
trade). Read exporter shares as availability of the alloy addition, not of steel itself.
"""
...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "out", "steel_trade.json")
BATCHES = [
...
CODES = {
    "720293": {"title": "Ferro-niobium", "boundary": "The niobium alloy addition; ~92% traces to Brazilian niobium, but trade routes through processors."},
    "720292": {"title": "Ferro-vanadium", "boundary": "The vanadium alloy addition; coupled to steelmaking-slag recovery, China-led."},
    "720241": {"title": "Ferro-chromium, >4% carbon", "boundary": "The chromium alloy addition for stainless; China leads ferrochrome from South African ore."},
    "720211": {"title": "Ferro-manganese, >2% carbon", "boundary": "The manganese alloy addition; every steel needs it, processing China-led."},
}

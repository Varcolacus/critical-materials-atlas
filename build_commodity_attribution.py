...
<article style="max-width:1060px">
  ...
  <div class="keyline" style="background:#f2f6f5;border-color:#d9e6e3;border-left-color:#0e7c74">
    <b style="color:#0e7c74">Where we land against it.</b> Our transparent stack of <b>13 public registers</b> independently reaches <b id="benchpct">63%</b> attribution on the Maus&nbsp;2022 footprint &mdash; roughly <b>10&nbsp;points behind the frontier</b>, using nothing but open, individually-downloadable sources and a spatial join anyone can re-run (their clustering is more sophisticated, and their footprint base is larger). More telling is that <b>the two agree on the shape</b>: they find coal (22.5%) and gold (21.1%) dominate the <i>labelled</i> footprint &mdash; exactly the mix our own bars show &mdash; and their unassigned quarter is not a hidden reserve of critical minerals. Where their bespoke method pushes coverage further, this page adds the piece they don&rsquo;t: an explicit <a href="#" onclick="document.getElementById('comptab').scrollIntoView({behavior:'smooth'});return false">census of what the unlabelled footprint is made of</a>. Independently reproducing ~86% of the frontier&rsquo;s coverage from fully open data, and being candid about the gap, is the honest claim here &mdash; not a new record.
  </div>

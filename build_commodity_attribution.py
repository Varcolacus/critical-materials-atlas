...
<article style="max-width:1060px">
  ...
  <p class="muted" style="margin-top:0">The obvious question &mdash; would more mine registers help? &mdash; tested directly. We stack <b>a dozen independent public sources</b> onto Jasansky and re-run the join: <b>USGS MRDS</b> (<span id="nmrds"></span> sites), <b>OpenStreetMap</b> (<span id="nosm"></span> commodity-tagged mines), the <b>USGS critical-minerals deposit set</b> (<span id="npp"></span> curated points), a national cadastre (<b>Geoscience Australia</b>, <span id="nau"></span>), and &mdash; crucially &mdash; the one dataset that covers <i>artisanal</i> mining, <b>IPIS</b> (<span id="nipis"></span> eastern-DRC &amp; CAR sites), <b>Wikidata</b> (<span id="nwd"></span> mines, CC0), the <b>USGS global mineral-operations file</b> (reaching Russia/China/Indonesia) and <b>national geological surveys</b> (<span id="nns"></span> occurrences &mdash; Canada BC-MINFILE, Brazil SIGMINE, Finland&rsquo;s GTK Fennoscandian database covering FI/SE/NO/NW-Russia, and Peru&rsquo;s INGEMMET occurrence inventory). Coverage triples &mdash; and because the sources are independent, where two label the <i>same</i> mine we can check whether they <b>agree</b>.</p>

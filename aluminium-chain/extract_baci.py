"""Extract aluminium-chain trade context from local BACI archives.

Trade context only: customs codes cannot see smelter power sources or captive integration, and
unwrought aluminium routes through metal hubs. Read shares as availability of the traded form.
"""
...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "out", "aluminium_trade.json")
BATCHES = [
...
CODES = {
    "260600": {"title": "Aluminium ores and concentrates (bauxite)", "boundary": "The ore; Guinea/Australia/Indonesia lead. Indonesia banned raw exports to force domestic refining."},
    "281820": {"title": "Aluminium oxide (alumina), excl. corundum", "boundary": "The refined intermediate (Bayer process); China and Australia lead."},
    "760110": {"title": "Aluminium, unwrought, not alloyed", "boundary": "Primary metal as traded; routes through metal hubs, and captive/integrated smelter output may not appear."},
    "760120": {"title": "Aluminium, unwrought, alloyed", "boundary": "Alloyed primary/secondary metal; mixes primary and recycled sources."},
}

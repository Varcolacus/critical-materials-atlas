...
<article style="max-width:1040px">
  ...
  <p>The clean result would have been &ldquo;squeeze predicts price.&rdquo; The real one is sharper: companionality raises the <i>variance</i> of price outcomes, not their direction. Gallium and germanium &mdash; by-product-locked and hit by 2023 export controls &mdash; spiked; cobalt, equally by-product-locked, <i>fell</i> as Indonesian nickel dragged a flood of by-product cobalt to market. Same structure, opposite prices, because the host&rsquo;s cycle decides. That is exactly why the <a href="host-shock.html">host-shock</a> layer matters, and it points to the next child: track each squeeze metal&rsquo;s price <i>against its host&rsquo;s</i> output, not its own demand. The thesis survives &mdash; refined, not refuted.</p>
</article>
<footer class="siteftr"><div class="wrap">
  <div><h4>Critical Materials Atlas</h4>An independent demonstration from public data. Not affiliated with, nor representing, any institution.</div>
  <div><h4>Navigate</h4><a href="demand.html">The squeeze</a><br><a href="volume.html">Value vs volume</a><br><a href="host-shock.html">Host shock</a><br><a href="limitations.html">Limitations</a></div>
...
Promise.all([fetch('out/price_squeeze.json').then(r=>r.json()),
  ...
  document.getElementById('keyline').innerHTML='<b>Read it honestly:</b> the raw squeeze&harr;price correlation (+'+cc+') is modest, and even that leans on gallium, germanium and hafnium &mdash; which share one HS6 code and so post the <i>identical</i> +454%, one signal masquerading as three. Strip the double-counting and the claim is not &ldquo;squeeze raises prices&rdquo; but &ldquo;squeeze raises <i>turbulence</i>&rdquo;: inelastic-supply metals swing harder ('+vb+'% vs '+vp+'%), up when supply is restricted (gallium, germanium — 2023 export controls) and down when the host floods the market (cobalt via Indonesian nickel). Direction is the host&rsquo;s to decide.';

...
CHAIN = {
    "title": "Boron chain",
    "chokepoint": {"product": "Fibreglass · fertilizer · magnets", "stage": "Reserves", "mechanism": "geological", "physics": "Turkey's borate deposits are geologically exceptional — ~70% of world reserves; the deposit can't be relocated", "holder": "Turkey", "share": "~70% reserves", "control": "—", "conf": "measured"},
    "published": True,
    ...
    "deck": "Boron, mined as borates, is in fibreglass and glass, in fertilizer as an essential micronutrient, in "
            ...
            "comes from just two places: Turkey, which sits on roughly 70% of world reserves, and a single large mine "
            "in California. It is a chokepoint written into the geology.",
    "byline": "borate ore (Turkey ~70% reserves + US) ≠ boric acid / borax ≠ fibreglass · fertilizer · borosilicate · NdFeB",
    "correction": "Boron is one of the atlas's few genuinely geological chokepoints. Turkey holds around 70% of world "
                  "borate reserves — an exceptional geological endowment, mined by the state producer Eti Maden — and "
    ...
    "stats": [
        {"v": "~70% Turkey", "l": "of world borate reserves — a geological concentration", "conf": "measured"},
    ...
    "hops": [
        {"n": "1 · Borate ore", "t": "tincal, colemanite, ulexite — Turkey ~70% of reserves, plus California"},
    ...
    "sections": [
        {"h2": "1 · A chokepoint in the ground", "panels": [
            {"kind": "big", "h3": "Where the boron is", "big": "~70% Turkey", "conf": "measured",
             "text": "Turkey's borate basins are a geological rarity: they hold roughly 70% of world reserves, mined by "
                     "the state-owned Eti Maden. The only other major source is a single large open-pit mine in Boron, "
                     "California. A handful of smaller producers (Chile, Argentina, Russia, China) supply the rest. This "
                     "is not a built concentration that capital can relocate — it is where the deposits happen to be, "
                     "like phosphate or the platinum-group Bushveld.",
             "note": "USGS Boron 2026; Eti Maden."},
    ...
    "method": [
        {"stage": "Reserves", "lens": "USGS reserves + Eti Maden", "why": "~70% Turkey — a geological chokepoint"},
...
print("wrote", os.path.relpath(OUT, HERE), "- boron, ~70pct Turkey reserves (geological, 4th); glass/fertilizer/NdFeB")
